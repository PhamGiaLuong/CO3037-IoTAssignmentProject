...
void setup() {
    ...
    // xTaskCreate(readSensorTask, "SensorTask", 4096, NULL, 6, NULL);
    ...
    // xTaskCreate(espNowRxTask, "EspNowRxTask", 4096, NULL, 4, NULL);
    // xTaskCreate(espNowTxTask, "EspNowTxTask", 4096, NULL, 4, NULL);
    xTaskCreate(coreIotTask, "CoreIotTask", 4096, NULL, 3, NULL);
